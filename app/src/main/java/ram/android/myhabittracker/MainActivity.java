...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button insertButton = (Button) findViewById(R.id.b1);
        ...
        insertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                EditText hab = (EditText) findViewById(R.id.text1);
                String exhab = hab.getText().toString();
                EditText dur = (EditText) findViewById(R.id.text2);
                int exdur = Integer.parseInt(dur.getText().toString());
